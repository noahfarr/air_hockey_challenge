...
from air_hockey_agent.reppo.src.torchrl.reppo import (
...
def main():
    ...
    if args.env_name.startswith("h1hand-") or args.env_name.startswith("h1-"):
        ...
        from air_hockey_agent.reppo.src.env_utils.torch_wrappers.mtbench_env import MTBenchEnv
    ...
    if args.agent == "fasttd3":
        if env_type in ["mtbench"]:
            from air_hockey_agent.reppo.src.network_utils.fast_td3_nets import (
                MultiTaskActor,
                MultiTaskCritic,
            )
            ...
            from air_hockey_agent.reppo.src.network_utils.fast_td3_nets import Actor, Critic
        ...
        if env_type in ["mtbench"]:
            from air_hockey_agent.reppo.src.network_utils.fast_td3_nets_simbav2 import (
                MultiTaskActor,
                MultiTaskCritic,
            )
            ...
            from air_hockey_agent.reppo.src.network_utils.fast_td3_nets_simbav2 import Actor, Critic
